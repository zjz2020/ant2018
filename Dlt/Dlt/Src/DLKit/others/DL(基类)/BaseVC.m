...
- (void)viewDidLoad {
    ...
    {
        UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"password1_00"] style:UIBarButtonItemStylePlain target:self action:@selector(backAction)];
...
-(void)addleftitem
{
    UIButton * leftbtn = [[UIButton alloc]initWithFrame:RectMake_LFL(10, 10, 25, 25)];
    [leftbtn setImage:[UIImage imageNamed:@"personal_20"] forState:UIControlStateNormal];
