...
//    //这是我的标记deep
//    self.originalBtn = [UIButton buttonWithFrame:CGRectMake(140, 194, 18, 18) Target:self Selector:@selector(originalSwitch:) Image:@"SuPhoto_unselected.png" ImageSelected:@"choose.png"];
...
- (void)showXiangCeSender:(UIViewController *)sender handle:(void(^)(NSArray<UIImage *> * photos))handle{
    self.sender = sender;
    [sender.view addSubview:self];
    [SuPhotoCenter shareCenter].handle = handle;
    [self albumBrowser ];
