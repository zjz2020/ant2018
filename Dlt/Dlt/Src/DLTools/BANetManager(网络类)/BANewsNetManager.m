...
+(id)getsmsParmeters:parameters completionHandle:(void(^)(id model, NSError *error))completionHandle
{
//    NSString * path = [NSString stringWithFormat:@"UserCenter/register"];
    NSString * urlpath =[NSString stringWithFormat:@"%@UserCenter/sendSMS",BASE_URL];
    
    
    return [BANetManager ba_requestWithType:BAHttpRequestTypePost urlString:urlpath parameters:parameters successBlock:^(id response) {
...
+(id)validationsmsParmeters:parameters completionHandle:(void(^)(id model, NSError *error))completionHandle
{
    NSString * urlpath = @"http://117.34.109.146:3344/api/UserCenter/checkSMSCode";
    return [BANetManager ba_requestWithType:BAHttpRequestTypePost urlString:urlpath parameters:parameters successBlock:^(id response) {
