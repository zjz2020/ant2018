...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"friend_00"] style:UIBarButtonItemStyleDone target:self action:@selector(backButtonEvent)];
