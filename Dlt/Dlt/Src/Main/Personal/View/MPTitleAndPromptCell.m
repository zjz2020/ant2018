...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (self.keyLabel==nil) {
            ...
            self.keyLabel.font=AdaptedFontSize(16);
        ...
        if (self.valueTextField==nil) {
            ...
            self.valueTextField.font=AdaptedFontSize(16);
            ...
            [self.valueTextField mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                make.size.mas_equalTo(CGSizeMake(ScreenWidthLFL-80-2*spaceWith, AdaptedHeight(18)));
            }];
        }
